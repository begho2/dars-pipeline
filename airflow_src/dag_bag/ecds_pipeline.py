...
from src.data_catalog.headings import ECDS_HEADINGS
...
ecds_dag = DAG(
    ...
    default_args=args,
    description="""
        load a sample of ECDS zip file and transform to postgres. 
    """,
...
with ecds_dag:
    ...
    sub_dags = create_all_subdag_operators(ecds_dag, ecds_zip_files, DB_PROPERTIES, table_name, runtime_limit, batch_size)
