...
from src.data_catalog.headings import OP_HEADINGS
...
op_dag = DAG(
    ...
    default_args=args,
    description="""
        load a sample of op zip file and transform to postgres.
    """,
...
with op_dag:
    ...
    sub_dags = create_all_subdag_operators(op_dag, op_zip_files, DB_PROPERTIES, table_name, runtime_limit, batch_size)
